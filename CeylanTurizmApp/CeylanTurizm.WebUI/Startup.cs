...
namespace CeylanTurizm.WebUI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationContext>(options => options.UseSqlite("Data Source=CeylanTurizmApp"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                   ...
                   defaults: new { controller = "Home", Action = "TicketFound" }
                   );
                endpoints.MapControllerRoute(
                    name: "ticketQuery",
                    pattern: "bilet/sorgu",
                    defaults: new { controller = "Home", Action = "TicketQuery" }
                    );
                endpoints.MapControllerRoute(
                    name: "city",
                    pattern: "city/{name}",
