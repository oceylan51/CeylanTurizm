    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)//Başarılı bir şekilde create gerçekleştiyse
            {
                ...
                await _emailSender.SendEmailSenderAsync(model.Email, "Ceylan Turizm Ltd. Şti. Account Active!", $"Lütfen email adresinizi onaylamak için <a href='https://localhost:5001{url}'>tıklayınız!</a>");
